                        ...
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton4">
                                <div class="dropdown-menu-content">
                                    <a id="act" class="dropdown-item" href="view-allusers.php">Action</a>
...
?>
                        ...
                        <p class="text-dark">Total Number of Users</p>
            ...
            <div class="col-sm-6 col-lg-6">
                <div class="card text-brown bg-flat-color-2">
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
...
?>
                        ...
                        <p class="text-dark">Total Computers</p>
