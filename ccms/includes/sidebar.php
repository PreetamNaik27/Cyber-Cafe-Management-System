<aside id="left-panel" class="left-panel" style="background-color: #000000;">
...
?>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse" style="background-color: #000000;">
...
<li class="menu-item-has-children dropdown">
 ...
 <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-user"></i><a href="manage-newusers.php">Manage User</a>
                            </li>
                            <li><i class="fa fa-user"></i><a href="manage-olduser.php">View All Users</a>
                            </li>
...
<li class="active">
  ...
  <li class="menu-item-has-children dropdown">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-user"></i>About us</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-user"></i><a href="">Preetam Naik</a></li>
                            <li><i class="menu-icon fa fa-user"></i><a href="">Adarsh Masekar</a></li>
                            <li><i class="menu-icon fa fa-user"></i><a href="">Devendra Lamani</a></li>
                            <br><br><br>
                    ...
                    <li class="">
                        <a href="#" class="" data-toggle="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;All the rights reserved by <br>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &copycybercafe 2022</a>
